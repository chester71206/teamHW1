...
public class womanaction : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       randomIndex = Random.Range(0, food.Length-1);
        ...
        targetFood.transform.position = new Vector3(targetFoodposition_x, targetFoodposition_y, 1);
    ...
    {        
            ...
            if (Input.GetKeyDown(KeyCode.Space) && isback == false && index==food.Length-1 ) //如果要送餐
             {
